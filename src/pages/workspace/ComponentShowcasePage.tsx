...
import { 
  Search, Mail, Plus, 
  Upload, Download, FileSpreadsheet, Package, Truck, Calendar, MapPin, CheckCircle2,
  Trash2, Edit, Printer, FileText, Settings, Bell, User
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#FCFCFD]">
      ...
      <div className="space-y-8">
        ...
        <Card>
          <CardHeader title="Advanced Form Inputs" description="Checkboxes, Radios, Switches, and Date Pickers" />
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="space-y-4">
                <h4 className="text-sm font-semibold text-[#1A1D21] border-b pb-2">Switches (Toggles)</h4>
              ...
              <div className="space-y-4">
                <h4 className="text-sm font-semibold text-[#1A1D21] border-b pb-2">Date Picker</h4>
                <DatePicker 
                  label="Delivery Date" 
                  date={date} 
                  onChange={setDate} 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <Avatar size="xl" fallback="GH" src="https://ui-avatars.com/api/?name=GHN&background=0F766E&color=fff" />
                    <Avatar size="xl" fallback="JS" src="invalid-url.jpg" />
                  </div>
                </div>

                <div>
                  <h4 className="text-sm font-semibold text-[#1A1D21] mb-4">Toast Notifications (Sonner)</h4>
                  <div className="flex flex-wrap gap-3">
                    <Button size="sm" variant="outline" onClick={() => toast.success('Order #1234 has been shipped successfully!')}>Success</Button>
                    <Button size="sm" variant="outline" onClick={() => toast.error('Failed to update inventory.')}>Error</Button>
                    <Button size="sm" variant="outline" onClick={() => toast.warning('Low stock alert for SKU-998.')}>Warning</Button>
                    <Button size="sm" variant="outline" onClick={() => toast.info('System maintenance scheduled at midnight.')}>Info</Button>
                  </div>
                </div>
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
              ...
              <div className="flex flex-col items-center justify-center p-4 border rounded-lg hover:border-[#0F766E] transition-colors group">
                <FileSpreadsheet className="text-[#475569] group-hover:text-[#0F766E] mb-2" size={24} />
        ...
        <Card>
          <CardHeader
            title="Color Palette"
            description="SmartChain design tokens reference"
          />
          <CardContent>
